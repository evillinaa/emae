...
public:
    ...
    void Print() 
    {
        ...
        std::cout << "Количество ножек: " << GetCountOfLegs() << "\n";
...
int main()
{
    ...
    ArmchairCollection[0].SetArticle("333Ld");
    ArmchairCollection[0].SetName("Ommaoppa");

    ArmchairCollection[0].Print();

    myArmchair.SetArticle("m3m4");
    myArmchair.SetColor("Black");
    myArmchair.SetCountOfLegs(5);
    myArmchair.SetHigh(250);
    myArmchair.SetMaterial("plastik");
    myArmchair.SetName("Vasya");
    myArmchair.SetWidth(250);
    myArmchair.Price(90000);
